<%-- 
    Document   : Sepultura
    Created on : 27 oct 2024, 20:14:21
    Author     : Acer
--%>
            ...
            <section id="services" class="services section light-background">
                ...
                <div class="container">
                    ...
                    <div class="row justify-content-center gy-4">
                        ...
                        <!-- Formulario de Registro de Difuntos -->
                        <div class="col-lg-6 col-md-8" data-aos="fade-up" data-aos-delay="100">
                            <div class="service-item position-relative text-center">
                                <div class="icon mb-3">
                                    <i class="fa-solid fas fa-cross"></i>
                                </div>
                                <h2>Registro de Difuntos</h2>
                                <br><br>
                                <form action="<%= request.getContextPath()%>/controlador/ControladorDifunto" method="post" class="registro-form">
                                    <div class="mb-3">
                                        <label for="nombre" class="form-label">Nombres del Difunto</label>
                                        <input type="text" class="form-control" value="${nombredif}" id="nombre" name="nombre" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="apellido" class="form-label">Apellidos del Difunto</label>
                                        <input type="text" class="form-control" value="${apellidodif}" id="apellido" name="apellido" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="fechaNacimiento" class="form-label">Fecha de Nacimiento</label>
                                        <input type="date" class="form-control" value="${fecNacimiento}" id="fechaNacimiento" name="fechaNacimiento" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="fechaFallecimiento" class="form-label">Fecha de Fallecimiento</label>
                                        <input type="date" class="form-control" value="${fecFallecimiento}" id="fechaFallecimiento" name="fechaFallecimiento" required>
                                    </div>
                                    <div class="mb-3">
                        ...
                        </div><!-- End Formulario de Registro de Difuntos -->
