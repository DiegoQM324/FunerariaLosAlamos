<%-- 
    Document   : Difuntos
    Created on : 25 oct 2024, 12:02:37
    Author     : Acer
--%>

<%@page import="modelo.dto.Difunto"%>
<%@page import="java.util.List"%>
<%@page import="modelo.dao.DifuntoDAO"%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <h1 class="text-center mt-4">Lista de Difuntos</h1>
                            ...
                            <div class="table-container">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                            <td><%= difunto.getIdDifunto()%></td>
                                            <td><%= difunto.getNombreDif()%></td>
                                            <td><%= difunto.getApellidosDif()%></td>
                                            <td><%= difunto.getFecNacimiento()%></td>
                                            <td><%= difunto.getFecFallecimiento()%></td>
                                            <td><%= difunto.getLugarFallecimiento()%></td>
                                        </tr>
                                        <%
                                            }
                                        %>
                                ...
                                <form action="<%= request.getContextPath()%>/controlador/ControladorDifunto" method="post">
                                    <button type="submit" name="accion" value="exportarExcel" class="btn btn-success btn-sm">
                                        <i class="fas fa-file-excel"></i> Exportar Difuntos a Excel
                                    </button>
                                </form> 
                            </div>
                        </div>
                    ...
                    <footer class="sticky-footer bg-white">
                        <div class="container my-auto">
                            <div class="copyright text-center my-auto">
                                <span>Copyright &copy; Los Alamos</span>
                            </div>
                        </div>
                    </footer>
                    <!-- End of Footer -->
            ...
            <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Selecciona "Cerrar sesión" si te encuentras listo para salir de la sesión.</div>
